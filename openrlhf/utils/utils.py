...
def pad_to_longest(texts: List[str], tokenizer) -> List[torch.Tensor]:
    """
    Tokenize and pad a list of strings to the longest sequence in the list.

    Args:
        texts: List of strings to tokenize and pad
        tokenizer: Tokenizer to use

    Returns:
        List of padded tensors, each of shape (max_length,)
    """
 ...
 # Tokenize with padding
    ...
    # return input_ids#[input_ids[i] for i in range(len(input_ids))]
